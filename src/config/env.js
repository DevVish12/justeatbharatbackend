...
const env = {
    ...
    CORS_ORIGIN: process.env.CORS_ORIGIN || "http://justeatbharat.com",
    BACKEND_BASE_URL: process.env.BACKEND_BASE_URL || "http://justeatbharat.com",
    ADMIN_API_PREFIX: process.env.ADMIN_API_PREFIX || "admin-auth-9x7k2",
    FRONTEND_BASE_URL: process.env.FRONTEND_BASE_URL || "http://justeatbharat.com",
